...
This was my first project using Svelte, so I decided to make a smaller project with a simpler interface. Despite that, I really liked the result. I plan to use and learn more about Svelte in the future and create even better projects.
...
```sh
git clone https://github.com/AdrianoEscarabote/frontendmentor-challenges/tree/main/blog-preview-card
```
